            ...
            <div className="p-4 border-t border-stone-800 bg-black/20">
               <div className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                     ...
                     <a href="https://ifdian.net/a/nogubird" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[10px] items-center text-yellow-500 hover:text-yellow-400 transition-colors truncate mt-1">
                        <Star className="w-3 h-3 flex-shrink-0" />
                        <span className="truncate font-bold">帮助作者更好创作 (感谢发电)</span>
                     </a>
                  </div>
               </div>
            </div>
