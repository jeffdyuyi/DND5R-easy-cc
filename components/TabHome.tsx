...
const TabHome: React.FC<Props> = ({ character, updateCharacter, libraryClasses }) => {
  ...
  return (
    <div className="p-6 bg-parchment min-h-full">
      <div className="flex flex-col md:flex-row gap-6 mb-8 items-center md:items-start border-b-2 border-dndRed pb-6">
        <div className="flex-shrink-0">
          <AvatarUploader
            avatarDataUrl={character.avatarDataUrl}
            onChange={(url) => updateCharacter({ avatarDataUrl: url })}
            size={120}
          />
        </div>
        <div className="flex-grow w-full">
          <h2 className="text-3xl font-bold text-dndRed mb-4 border-b border-stone-200 pb-2">角色概览</h2>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white p-4 rounded-lg shadow border border-stone-300 flex flex-col items-center">
              ...
              <div className="text-xs text-stone-400 mt-1">基础计算值</div>
            </div>
            <div className="bg-white p-4 rounded-lg shadow border border-stone-300 flex flex-col items-center">
