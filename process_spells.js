...
// Read TS file to get existing IDs
...
for (let i = 1; i < lines.length; i++) {
    ...
    if (!id) {
        // Handle alias
        if (name === '魔法爆发') id = 'sorcerous-burst'; // Mapping based on previous observation
        else if (name === '克敌机先') id = 'true-strike';
        else if (name === '元素主义') id = 'elementalism';
        else {
