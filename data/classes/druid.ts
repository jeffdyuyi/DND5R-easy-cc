...
export const DRUID_SUBCLASSES: SubclassItem[] = [
    {
        ...
        parentClass: "德鲁伊",
        source: "官方规则",
        description: "大地结社由守护着远古知识与仪式的秘术师和智者们构成。这些德鲁伊们聚集在树木的圣环下或石阵之中，他们用德鲁伊语低声交流，传递着原初的秘密。结社中最睿智的成员如教团的首席祭司地位般尊贵。",
        features: [
            {
                level: 3,
    ...
    },
    {
        ...
        parentClass: "德鲁伊",
        source: "官方规则",
        description: "月亮结社的德鲁伊凭借月亮的魔法让自己改变形态。他们的结社成员们在月下相聚，分享见闻，举行仪式。该结社的德鲁伊如月亮般善变，他们荒野存在于这些德鲁伊的血液之中。",
        features: [
            {
                level: 3,
    ...
    },
    {
        ...
        parentClass: "德鲁伊",
        source: "官方规则",
        description: "海洋结社的德鲁伊们驱使着世界上海洋和风暴中狂野的自然之力。其中一些德鲁伊将自己视作自然怒火的化身，对那些掠夺自然世界的人们施以报复。而另一些德鲁伊则顺应潮汐的涨落，跟随洋流和波浪的激荡，聆听狂风的低语和怒号，从中寻求和自然的灵性统一。",
        features: [
            {
                level: 3,
    ...
    },
    {
        ...
        parentClass: "德鲁伊",
        source: "官方规则",
        description: "在无法追忆的过去，星辰结社的德鲁伊们便开始记录天穹中的图案，探索星座之间隐藏的秘密。通过理解这些秘密，这个结社的德鲁伊探索着如何驾驭宇宙的伟力。",
        features: [
            {
                level: 3,
                name: "星图 (Star Map)",
